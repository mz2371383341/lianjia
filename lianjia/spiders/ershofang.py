...
# 继承至 RedisCrawlSpider
class ErshofangSpider(RedisCrawlSpider):
    name = 'ershofang'
    allowed_domains = ['su.lianjia.com']
    # start_urls = ['https://su.lianjia.com/ershoufang/']
    redis_key = 'ershofangfangspider:start_urls'
    #  scrapy runspider xxx.py启动   打开终端进入redis数据库(resid-cli),输入 lpush ershofangfangspider:start_urls "https://su.lianjia.com/ershoufang/"
